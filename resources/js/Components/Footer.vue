    ...
    <footer class="p-4 py-8 bg-gray-50 md:p-8 lg:p-10 dark:bg-gray-800">
        <div class="mx-auto max-w-screen-xl text-center">
            <div class="grid lg:grid-cols-3">
                <Link :href="route('posts.index')" class="flex items-center mb-4 text-2xl font-semibold text-gray-900 lg:mb-0 dark:text-white">
                ...
                <ul v-if="canLogin" class="flex flex-wrap items-center mb-4 text-sm text-gray-500 lg:mb-0 dark:text-gray-400">
                    ...
                    <div v-else class="flex flex-wrap">
                        <li>
                            <Link :href="route('login')" class="mr-4 hover:underline md:mr-6 ">Login</Link>
                        </li>
                        <li v-if="canRegister">
                            <Link :href="route('register')" class="mr-4 hover:underline md:mr-6">Register</Link>
                        </li>
                    </div>
                </ul>

...
<template>
    ...
    >
        <ul class="flex items-center justify-center -space-x-px">
            <li
                v-for="(link, index) in compactLinks"
                :key="index"
            >
                <Link
                    v-if="link.url"
                    ...
                    :class="[
                        index === 0 ? 'rounded-s-lg border-e-0' : '',
                        index === compactLinks.length - 1 ? 'rounded-e-lg' : '',
                        link.active
                ...
                <span
                    ...
                    class="flex items-center justify-center px-3 h-8 leading-tight text-gray-400 bg-gray-100 border border-gray-300 cursor-not-allowed dark:bg-gray-700 dark:border-gray-700 dark:text-gray-500"
                    v-html="link.label"
                />
            </li>
        </ul>
